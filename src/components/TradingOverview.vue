        ...
        <div class="card-wrap mb-8">
          <div class="flex flex-wrap gap-4 items-center justify-between">
            <div class="flex flex-col gap-2">
              ...
              <select v-model="selectedPair" class="rounded border px-3 py-2" style="cursor:pointer">
                <option v-for="pair in marketPairs" :key="pair.symbol" :value="pair" style="cursor:pointer;color: black;">{{ pair.label }}</option>
              </select>
            </div>
            <div class="flex flex-col gap-2">
              <label class="font-semibold text-dark dark:text-white">Leverage</label>
              <select v-model="selectedLeverage" class="rounded border px-3 py-2" style="cursor:pointer">
                <option v-for="lev in leverages" :key="lev" :value="lev" style="cursor:pointer;color: black;">{{ lev }}X</option>
              </select>
            </div>
            <div class="flex flex-col gap-2">
